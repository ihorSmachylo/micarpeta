...
while (i >= 0){
  console.log( "contando..."+1;//imprimo 
  i--;//hace  que reste el activaador
}
...
/
let count2 = 100; // variable con valor 100

do { // entro en el do, siempre al menos una vez...
  console.log(count2); // imprimo el 100.
  count2--; // y restame uno...
} while (count2 >= 0); // repite el bucle MIENTRAS la variable sea mayor o igual a 0.
...
------------------*/
 ...
 while (start > end) {console.log(end)
   end++;
 }
