...
*/
// ejercico en casa
//1:Escribe un programa que muestre en pantalla “Hola” seguido de tu nombre guardado en una variable.//*

let miNombre =" ihor"
let saludo = "hola"
console.log(saludo,miNombre)
// EJERCICO 2 Escribe un programa que pida al usuario un número y convierta el string a un int y lo muestre en pantalla

//let usuario1 = parseInt(prompt("dime un número"));
//console.log(prompt+numero1)
//console log 

//EJERCICIO3 Escribe un programa que muestre la suma de dos números.

let suma1 =3 ; let suma2 = 4;
//console.log(suma1+suma2)

//EJERCICIO 4 Escribe un programa que calcule la división de dos números y lo muestre en pantalla

//console.log(suma2/suma1)

// ejerciocio 5 pantalla5.Escribe  unprograma  que  pida  dos  números  al  usuario  y  muestre  el  resultado  de multiplicar los dos
0
...
// EJERCICIO 6 Escribe un programa que muestre el resultado de las siguientes operaciones:

//console.log((-5) + 8 * 6)
//console.log((55 + 9) % 6)
//console.log( 20 + (-3*5) / 8)
//console.log ((5 + 15) / (3 * 2) - (8 % 3))
//console.log ((25.5 * 3.5) - (3.5 * 3.5)) / (40.5 - 4.5)
//console.log (4.0 * (1 - (1.0/3) + (1.0/5) - (1.0/7) + (1.0/9) - (1.0/1)))
...
//console.log(numero1*=9)
//console.log(numero1*=10)

// ejercicio 9 


// ejercicio 10 Escribe  un  programa  que  pida  tres  números al  usuario  y  que  calcule  y  muestre  su media.


//let numero1 = parseInt(prompt("dime un número"));
//let numero2 = parseInt(prompt("dime otro número"));
//let numero3 = parseInt(prompt("dime otro número"));
//console.log(prom= numero1+numero2+numero3)

// ejercicio 11

//let temperatura = parseint(prompt("dime una temperatura "))
//console.log("en farenheit son "+ temperatura *(9/5)+32)
